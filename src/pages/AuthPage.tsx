...
const AuthPage = () => {
  ...
  const whyChooseFeatures = [
    { icon: Users, title: '50,000+ Travel Agents', description: 'Join thousands of successful agents on our B2B platform' },
    { icon: Award, title: '16+ Travel Products', description: 'All travel services in one comprehensive platform' },
    { icon: Shield, title: 'Trusted Globally', description: 'Partnerships with the biggest industry players' },
    { icon: Headphones, title: '24/7 Support', description: 'Regional language support for your convenience' },
    { icon: TrendingUp, title: 'Excellent Returns', description: 'Best commission structure in the industry' },
    { icon: Globe2, title: '55+ Branches', description: 'Physical presence across India for your support' },
  ];

  const products = [
    { icon: Plane, name: 'Flights', color: 'from-blue-500 to-blue-600' },
    { icon: Hotel, name: 'Hotels', color: 'from-purple-500 to-purple-600' },
    { icon: Car, name: 'Car Rental', color: 'from-green-500 to-green-600' },
    { icon: Ship, name: 'Cruise', color: 'from-cyan-500 to-cyan-600' },
    { icon: Ticket, name: 'Bus', color: 'from-orange-500 to-orange-600' },
    { icon: Building2, name: 'Rail', color: 'from-red-500 to-red-600' },
    { icon: MapPin, name: 'Theme Parks', color: 'from-pink-500 to-pink-600' },
    { icon: Briefcase, name: 'Insurance', color: 'from-indigo-500 to-indigo-600' },
  ];

  return (
    <div className="relative bg-gradient-to-br from-pink-50 via-red-50 to-orange-50">
      {/* Scroll Indicator */}
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {whyChooseFeatures.map((feature, index) => (
              <Card 
                key={index}
                className="p-8 hover:shadow-xl transition-all duration-300 animate-fade-in border-2 hover:border-primary/50"
      ...
      <section 
        ...
        className="min-h-screen py-20 px-4 bg-white/50 relative"
      >
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16 animate-fade-in">
            <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {products.map((product, index) => (
              <Card 
                key={index}
                className="p-6 hover:shadow-2xl transition-all duration-300 cursor-pointer group animate-scale-in border-0"
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {[
              ...
              <div 
                key={index}
                className="flex items-start gap-4 p-6 bg-white rounded-xl hover:shadow-lg transition-all animate-slide-in-left"
                style={{ animationDelay: `${index * 100}ms` }}
              >
