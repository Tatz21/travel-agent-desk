  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary/10 to-secondary p-3 md:p-6 relative overflow-hidden">
      ...
      <img 
        src={watermarkLogo} 
        alt="" 
        className="absolute top-10 -left-20 w-72 opacity-10 pointer-events-none rotate-12"
      />
      <img 
        src={watermarkLogo} 
        alt="" 
      ...
      <img 
        src={watermarkLogo} 
        alt="" 
        className="absolute top-20 right-10 w-72 opacity-10 pointer-events-none rotate-12"
      />
      <img 
        src={watermarkLogo} 
        alt="" 
      ...
      <img 
        src={watermarkLogo} 
        alt="" 
        className="absolute top-3/5 left-1/3 w-72 opacity-10 pointer-events-none rotate-12"
      />
      <img 
        src={watermarkLogo} 
        alt="" 
      ...
      <img 
        src={watermarkLogo} 
        alt="" 
        className="absolute bottom-10 -right-20 w-72 opacity-10 pointer-events-none rotate-12"
      />
      <img 
        src={watermarkLogo} 
        alt="" 
        className="absolute bottom-20 left-10 w-72 opacity-10 pointer-events-none rotate-12"
      />
      <img 
        src={watermarkLogo} 
        alt="" 
